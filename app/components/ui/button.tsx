...
const buttonVariants = cva(
  'inline-flex items-center justify-center rounded-md text-sm shadow-lg font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring focus-visible:ring-offset-1 disabled:pointer-events-none disabled:text-primary-800 disabled:bg-primary-600 disabled:border-none transition-colors duration-300',
  {
    variants: {
      variant: {
        ...
        secondary:
          'bg-white/10 text-primary-600 hover:bg-primary-950 hover:text-primary-200 border border-white/10 hover:border-white/20',
        ghost:
